...
```bash
export SKILLS_ROOT="${CENTAURAI_SKILLS_ROOT:-${SKILLS_ROOT:-$HOME/Library/Application Support/CentaurAI/SKILLs}}"
...
Installed skills resolve from `$CENTAURAI_SKILLS_ROOT` / `$SKILLS_ROOT` (production default: app `userData/SKILLs`, macOS usually `~/Library/Application Support/CentaurAI/SKILLs`).
