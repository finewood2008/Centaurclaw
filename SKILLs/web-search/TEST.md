...
This guide walks through testing the entire Web Search Skill integration with CentaurAI.

## Prerequisites

1. CentaurAI built and ready to run
2. Google Chrome installed
3. Internet connection available

## Test 1: Service Auto-Start

**Objective:** Verify that the Bridge Server starts automatically with CentaurAI.

**Steps:**

1. Start CentaurAI in development mode:
   ```bash
...
**Expected Result:** ✅ Bridge Server starts automatically within 3 seconds of CentaurAI launch.
...
1. Open a terminal while CentaurAI is running
...
**Objective:** Verify graceful shutdown of services when CentaurAI quits.

**Steps:**

1. With CentaurAI running and searches completed, quit the application
...
1. Start CentaurAI (ensure headless is false in config)
...
- ✅ Server auto-starts with CentaurAI
