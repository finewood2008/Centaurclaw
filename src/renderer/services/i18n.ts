...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    authQuotaExhausted: '今日免费额度已用完。您可以登录 CentaurAI Portal 购买套餐或积分包继续使用，或在设置中配置自己的 API Key。',
    authTopUpLink: '充值',
    authSettingsLink: '设置',
    ...
    coworkWorkingDirectoryHint: 'CentaurAI 将在此目录下执行命令',
    coworkSystemPrompt: '系统提示词',
    coworkSystemPromptPlaceholder: '为 CentaurAI 设置自定义指令...',
    coworkSystemPromptHint: '可选的系统提示词，用于自定义 CentaurAI 的行为',
    coworkModelSettingsRequired: '请先在模型设置中配置可用模型与 API Key。',
    coworkModelSettingsTitle: '模型设置',
    coworkModelSettingsHint: 'CentaurAI 使用模型设置中的当前模型与提供商配置。',
    ...
    coworkConfigSaveFailed: '保存 CentaurAI 配置失败，请稍后重试。',
    ...
    coworkPermissionDescription: 'CentaurAI 请求执行以下操作',
    coworkSelectionRequired: '请选择',
    coworkSelectionDescription: 'CentaurAI 需要你做出选择',
    coworkToolName: '工具名称',
    ...
    // 隐私协议弹窗
    privacyDialogTitle: 'CentaurAI服务协议',
    privacyDialogDesc: '在使用CentaurAI之前，请您仔细阅读{link}内容，并进行确认。',
    privacyDialogLinkText: 'CentaurAI服务协议',
  ...
  en: {
    ...
    authQuotaExhausted: 'Daily free quota exhausted. Visit CentaurAI Portal to purchase a plan or credits, or configure your own API Key in Settings.',
    ...
    // CentaurAI
    cowork: 'CentaurAI',
    coworkSettings: 'CentaurAI Settings',
    ...
    coworkWorkingDirectoryHint: 'CentaurAI will execute commands in this directory',
    coworkSystemPrompt: 'System Prompt',
    coworkSystemPromptPlaceholder: 'Set custom instructions for CentaurAI...',
    coworkSystemPromptHint: 'Optional system prompt to customize CentaurAI\'s behavior',
    ...
    coworkModelSettingsHint: 'CentaurAI uses the current model and provider configuration from Model Settings.',
    ...
    coworkConfigSaveFailed: 'Failed to save CentaurAI settings. Please try again.',
    ...
    coworkPermissionDescription: 'CentaurAI is requesting to perform the following action',
    coworkSelectionRequired: 'Please Choose',
    coworkSelectionDescription: 'CentaurAI needs your input',
    ...
    // Privacy dialog
    privacyDialogTitle: 'CentaurAI Terms of Service',
    privacyDialogDesc: 'Before using CentaurAI, please carefully read the {link} and confirm.',
    privacyDialogLinkText: 'CentaurAI Terms of Service',
