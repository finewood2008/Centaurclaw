 ...
 *
 * Log file locations:
 *   macOS:   ~/Library/Logs/CentaurAI/main-YYYY-MM-DD.log
 *   Windows: %USERPROFILE%\AppData\Roaming\CentaurAI\logs\main-YYYY-MM-DD.log
 *   Linux:   ~/.config/CentaurAI/logs/main-YYYY-MM-DD.log
 *
 * Rotation policy:
...
export function initLogger(): void {
  ...
  // Log startup marker
  log.info('='.repeat(60));
  log.info(`CentaurAI started (${process.platform} ${process.arch})`);
  log.info('='.repeat(60));
}
